-- Table: public.canthuekho

-- DROP TABLE IF EXISTS public.canthuekho;

CREATE TABLE IF NOT EXISTS public.canthuekho
(
    ...
    CONSTRAINT canthuekho_pkey PRIMARY KEY (id)
)

TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.canthuekho
    OWNER to postgres;

ALTER TABLE IF EXISTS public.canthuekho
    ENABLE ROW LEVEL SECURITY;

GRANT ALL ON TABLE public.canthuekho TO anon;

GRANT ALL ON TABLE public.canthuekho TO authenticated;

GRANT ALL ON TABLE public.canthuekho TO postgres;

GRANT ALL ON TABLE public.canthuekho TO service_role;

COMMENT ON TABLE public.canthuekho
    IS 'Cho thuê Cont';
-- POLICY: Enable insert for authenticated users only

-- DROP POLICY IF EXISTS "Enable insert for authenticated users only" ON public.canthuekho;

CREATE POLICY "Enable insert for authenticated users only"
    ON public.canthuekho
    AS PERMISSIVE
    FOR INSERT
    TO authenticated
    WITH CHECK (true);
...
-- DROP POLICY IF EXISTS "Enable read access for all users" ON public.canthuekho;
...
-- DROP POLICY IF EXISTS "Enable update for users based on email" ON public.canthuekho;
