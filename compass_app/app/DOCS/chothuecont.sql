...
ALTER TABLE IF EXISTS public.chothuecont
    OWNER to postgres;

ALTER TABLE IF EXISTS public.chothuecont
    ENABLE ROW LEVEL SECURITY;

GRANT ALL ON TABLE public.chothuecont TO anon;

GRANT ALL ON TABLE public.chothuecont TO authenticated;

GRANT ALL ON TABLE public.chothuecont TO postgres;

GRANT ALL ON TABLE public.chothuecont TO service_role;

COMMENT ON TABLE public.chothuecont
    IS 'Cho thuê Cont';
-- POLICY: Enable insert for authenticated users only

-- DROP POLICY IF EXISTS "Enable insert for authenticated users only" ON public.chothuecont;

CREATE POLICY "Enable insert for authenticated users only"
    ON public.chothuecont
    AS PERMISSIVE
    FOR INSERT
    TO authenticated
    WITH CHECK (true);
...
-- DROP POLICY IF EXISTS "Enable read access for all users" ON public.chothuecont;
...
-- DROP POLICY IF EXISTS "Enable update for users based on email" ON public.chothuecont;
