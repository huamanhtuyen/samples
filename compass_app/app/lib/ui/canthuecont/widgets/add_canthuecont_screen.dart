...
class AddCanThueContScreen extends StatefulWidget {
  const AddCanThueContScreen({super.key});

  @override
  State<AddCanThueContScreen> createState() => _AddCanThueContScreenState();
}

class _AddCanThueContScreenState extends State<AddCanThueContScreen> {
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (_formKey.currentState!.validate()) {
                      ...
                      final viewModel = context.read<CanThueContViewModel>();
                      await viewModel.addCanThueCont.execute(canThueCont);
                      if (!mounted) return;
                      final error = viewModel.addCanThueCont.error;
                      final errorMsg =
                          viewModel.addCanThueCont.result.toString();
                      if (error == false) {
