...
class EditChoThueContScreen extends StatefulWidget {
  final ChoThueCont choThueCont;

  const EditChoThueContScreen({super.key, required this.choThueCont});

  @override
  State<EditChoThueContScreen> createState() => _EditChoThueContScreenState();
}

class _EditChoThueContScreenState extends State<EditChoThueContScreen> {
  ...
  void initState() {
    super.initState();
    _mota = widget.choThueCont.mota ?? '';
    _tencty = widget.choThueCont.tencty ?? '';
    _sdt1 = widget.choThueCont.sdt1 ?? '';
    _sdt2 = widget.choThueCont.sdt2 ?? '';
    _sdt3 = widget.choThueCont.sdt3 ?? '';
    _matinh = widget.choThueCont.matinh ?? '';
    _tentinhTiengviet = widget.choThueCont.tentinhTiengviet ?? '';
    _tentinhTienganh = widget.choThueCont.tentinhTienganh ?? '';
    _tentinhTiengtrung = widget.choThueCont.tentinhTiengtrung ?? '';
    _tentinhTiengthai = widget.choThueCont.tentinhTiengthai ?? '';
    _maquan = widget.choThueCont.maquan ?? '';
    _tenquanTiengviet = widget.choThueCont.tenquanTiengviet ?? '';
    _tenquanTienganh = widget.choThueCont.tenquanTienganh ?? '';
    _tenquanTiengtrung = widget.choThueCont.tenquanTiengtrung ?? '';
    _tenquanTiengthai = widget.choThueCont.tenquanTiengthai ?? '';
    _anh1 = widget.choThueCont.anh1 ?? '';
    _anh2 = widget.choThueCont.anh2 ?? '';
    _anh3 = widget.choThueCont.anh3 ?? '';
    _anh4 = widget.choThueCont.anh4 ?? '';
    _anh5 = widget.choThueCont.anh5 ?? '';
    _anh6 = widget.choThueCont.anh6 ?? '';
    _anh7 = widget.choThueCont.anh7 ?? '';
    _anh8 = widget.choThueCont.anh8 ?? '';
    _anh9 = widget.choThueCont.anh9 ?? '';
  }
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (_formKey.currentState!.validate()) {
                      ...
                      final updatedChoThueCont = ChoThueCont(
                        id: widget.choThueCont.id,
                        mota: _mota,
                        tencty: _tencty,
                        sdt1: _sdt1,
                        sdt2: _sdt2,
                      ...
                      final viewModel = context.read<ChoThueContViewModel>();
                      await viewModel.updateChoThueCont.execute(
                        updatedChoThueCont,
                      );
                      if (!mounted) return;
                      final error = viewModel.updateChoThueCont.error;
                      final errorMsg =
                          viewModel.updateChoThueCont.result.toString();
                      if (error == false) {
